...

{
	...
	public  function get_all_pharmacy_details($a_id){
		$this->db->select('a_id,role,name,email,mobile,altmobile,address1,address2,city,state,country,zipcode,profile_pic,created_at,status,discount_per,qr_path')->from('admin');
