                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control"  name="" id="" placeholder="Enter Password" >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label> Confirm Password </label>
                                                <input type="text" class="form-control"  name="" id="" placeholder="reEnter Password" >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label >Mobile Number</label>
                                                <input type="number" class="form-control"  name="" id="" placeholder="Enter State" >
                                            </div>
                                            <div class="form-group col-md-6">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label >Country</label>
                                                <input type="text" class="form-control"  name="" id="" placeholder="Enter Country" >
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label> Pincode </label>
                                            ...
                                            <div class="col-md-12 text-center">
                                                    <a href="#" class="btn btn-primary">Add Lab</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
