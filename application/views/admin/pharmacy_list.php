            ...
            <div class="col-md-12">
                <div class="card card-topline-aqua">
					...
					<?php if(isset($pharmacy_details) && count($pharmacy_details)>0){ ?>
                        <table id="lablist" class="display table" style="width:100%;">
                            <thead>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="valigntop">
                                        <div class="btn-group">
                                            ...
                                            <a href="javascript;void(0);" onclick="admindeactive('<?php echo base64_encode(htmlentities($list['a_id'])).'/'.base64_encode(htmlentities($list['status']));?>');adminstatus('<?php echo $list['status'];?>')"  data-toggle="modal" data-target="#myModal" ><button class="btn btn-xs btn-info"><?php if($list['status']==0){ echo "Active"; }else{  echo "Deactive"; } ?></button></a>&nbsp;
