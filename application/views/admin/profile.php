            ...
            <div class="col-md-8 mx-auto">
                <div class="card card-topline-aqua">
                    <div class="card-head">
                        ...
                        <a href="<?php echo base_url('profile/edit/'); ?>" class="btn btn-primary btn-sm pull-right mt-2 mr-4">Edit</a>
                    </div>
                    <div class="card-body ">
                        <div class="table-responsive">
                            <table id="" class="table table-bordered" style="width:100%;">
                                <tbody>
                                    <tr>
                                        <td>Name</td>
                                        <td><?php echo isset($mlab_details['name'])?$mlab_details['name']:''; ?></td>
                                    </tr>
                                    <tr>
                                        <td>Mobile Number</td>
