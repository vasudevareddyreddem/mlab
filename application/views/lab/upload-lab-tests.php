                                ...
                                <div class="table-responsive">
                                    ...
                                    <table id="saveStage" class="display table table-striped" style="width:100%;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>
                                                    <?php echo isset($list['test_type'])?$list['test_type']:''; ?>
                                                </td>
                                                <td>
                                                    <?php echo isset($list['test_name'])?$list['test_name']:''; ?>
                                                </td>
                                                <td>
                                                    <?php echo isset($list['test_duartion'])?$list['test_duartion']:''; ?>
                                                </td>
                                                <td>
                                                    <?php echo isset($list['test_amount'])?$list['test_amount']:''; ?>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript;void(0);" onclick="admindeactive('<?php echo base64_encode(htmlentities($list['l_id'])).'/'.base64_encode(htmlentities($list['status']));?>');adminstatus('<?php echo $list['status'];?>')" data-toggle="modal" data-target="#myModal"><button class="btn btn-xs btn-info">
