    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-topline-aqua">
          ...
          <div class="card-body ">
            <div class="container">
              <form class="" action="<?php echo base_url('pharmacypickupboy/insert'); ?>" method="post" id="add_pickupboy" name="add_pickupboy" enctype="multipart/form-data">
              ...
              <div class="form-group col-md-6">
                <label >Address</label>
                <input type="text" class="form-control"  name="address1" id="address" placeholder="Enter Address" >
              </div>
              <div class="form-group col-md-6">
                <label>City</label>
              ...
              <div class="form-group col-md-6">
                ...
                <div class="form-group col-md-6">
                  <label> Pincode </label>
                  <input type="text" class="form-control"  name="zipcode" id="zipcode" placeholder="Enter PinCode" >
                </div>
