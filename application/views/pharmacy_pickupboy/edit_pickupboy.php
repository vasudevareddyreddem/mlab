    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card card-topline-aqua">
          ...
          <div class="card-body ">
            <div class="container">
              <form class="" action="<?php echo base_url('pharmacypickupboy/update'); ?>" method="post" id="add_pickupboy" name="add_pickupboy" enctype="multipart/form-data">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="col-md-12 text-center">
                  <button type="submit" class="btn btn-primary">Update Pickup Boy</button>
                </div>
              </div>
            </form>
          </div>
