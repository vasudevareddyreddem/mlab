                  ...
                  <?php if(isset($pickup_orders) && count($pickup_orders)>0) { ?>
                    ...
                    <?php foreach ($pickup_orders as $pickup_order) { ?>
                      <tr>
							...
							<td><?php echo $pickup_order['email']; ?></td>
							...
							<td>
							<?php if($pickup_order['status']!=3){ ?>
							<a href="<?php echo base_url('pharmacypickupboy/orderstatus/'.base64_encode($pickup_order['cust_order_id'])); ?>">Delivery</a>
							<?php } ?>
							</td>
						</tr>
                        <?php $sno++; ?>
