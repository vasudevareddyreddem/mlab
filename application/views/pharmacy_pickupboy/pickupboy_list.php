<div class="page-content-wrapper">
                    ...
                    <?php if(isset($pickupboy_list) && count($pickupboy_list) > 0){ ?>
                      ...
                      <?php foreach ($pickupboy_list as $list) { ?>
                        <tr>
                          ...
                          <td class="valigntop">
                              <div class="btn-group">
                                  <a href="<?php echo base_url('pharmacypickupboy/edit/'.base64_encode($list->a_id)); ?>"><button class="btn btn-xs btn-primary">Edit</button></a>&nbsp;
  ...
  function admindeactive(id) {
    $(".popid").attr("href", "<?php echo base_url('pharmacypickupboy/status'); ?>" + "/" + id);
  }
  ...
  function admindelete(id) {
    $(".popid").attr("href", "<?php echo base_url('pharmacypickupboy/delete'); ?>" + "/" + id);
  }
